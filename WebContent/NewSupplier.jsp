...
type:"POST",
url:"http://localhost:8088/api/newsupplier",
data:d,
...
success:function(data){
	...
	document.getElementById("divm").innerHTML = data;
...
<p id="divm5"></p>
<br><br>
<button type="submit" class="btn btn-primary" id="btn" class="btn">Add Supplier</button>
<p id="divm"></p>
</div>
</body>
</html>